...
public class Ex01_EqualsMain {
	...
	public static void main(String[] args) {
		...
		//Member에서 equals method를 재정의하기 전
		System.out.println(member1.equals(member3));	//아래결고와 동일
		System.out.println(member1 == member3);		//참조하는 주소가 같냐를 비교
	
		//Member class에서 id만 같으면 true
		System.out.println(member1.equals(member3));
		System.out.println(member1.equals(member2));

		//Member class에서 id와 name이 같아야 동일하다고 한경우
		System.out.println(member1.equals(member3));
		System.out.println(member1.equals(member2));
